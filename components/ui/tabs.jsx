...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "inline-flex g-auto rounded-md p-1 text-primary",
        className
      )}
      {...props} />
  );
